...
const PRODUCT_SECTIONS: FooterSection[] = [
  {
    titleKey: "sectionCM",
    links: [
      { key: "cmVibration", href: "/solutions/condition-monitoring/vibration-analysis" },
      { key: "cmAiDetection", href: "/solutions/condition-monitoring/ai-powered-condition-monitoring" },
      { key: "cmReliability", href: "/solutions/condition-monitoring/root-cause-and-reliability" },
      { key: "cmDowntime", href: "/solutions/condition-monitoring/downtime-prevention-and-reporting" },
      { key: "cmSensorSpecs", href: "/solutions/condition-monitoring/sensor-specifications" },
    ],
  },
  {
    titleKey: "sectionCMMS",
    links: [
      { key: "cmmsTroubleshooting", href: "/solutions/cmms/maintenance-sop" },
      { key: "cmmsWorkOrder", href: "/solutions/cmms/work-order-software" },
      { key: "cmmsInventory", href: "/solutions/cmms/inventory-management-software" },
      { key: "cmmsPreventive", href: "/solutions/cmms/preventive-maintenance-software" },
      { key: "cmmsMobile", href: "/solutions/cmms/mobile-app" },
    ],
  },
  {
    titleKey: "sectionOEE",
    links: [
      { key: "oeeTracking", href: "/solutions/oee/ai-production-tracking" },
      { key: "oeeOperator", href: "/solutions/oee/operator-performance" },
      { key: "oeeQuality", href: "/solutions/oee/digitalized-quality" },
      { key: "oeeDashboards", href: "/solutions/oee/custom-dashboards" },
      { key: "oeeUtility", href: "/solutions/oee/energy-trac" },
    ],
  },
  {
    titleKey: "sectionPricing",
    links: [
      { key: "pricingCM", href: "/solutions/condition-monitoring/vibration-sensor/pricing" },
      { key: "pricingCMMS", href: "/solutions/cmms/pricing" },
      { key: "pricingOEE", href: "/solutions/oee" },
    ],
  },
];
...
const INTEGRATIONS_SECTION: FooterSection = {
  ...
  links: [
    { key: "intOracle", href: "/solutions/integrations/oracle-netsuite" },
    { key: "intSAP", href: "/solutions/integrations/sap", external: true },
    { key: "intPowerBI", href: "/solutions/integrations/power-bi" },
    { key: "intAll", href: "/solutions/integrations" },
  ],
};
...
const RESOURCES_SECTION: FooterSection = {
  ...
  links: [
    { key: "resCaseStudies", href: "/case-studies" },
    { key: "resEbooks", href: "/resources", external: true },
    { key: "resBlog", href: "/blog" },
    { key: "resSOPs", href: "/assets" },
    ...
    { key: "resCalculators", href: "/resources/calculators/maintenance-calculators" },
  ],
};
...
const SUPPORT_SECTION: FooterSection = {
  ...
  links: [
    { key: "supAbout", href: "/about" },
    { key: "supReferrals", href: "/referrals" },
    { key: "supCareers", href: "https://careers.tractian.com/", external: true },
    { key: "supNewsroom", href: "/press" },
    { key: "supWarranty", href: "/hardware-warranty" },
    { key: "supSLA", href: "/service-level-agreement" },
...
function PhoneIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="h-4 w-4" strokeWidth={1.5} {...props}>
        ...
        <div className="mt-2 flex w-full flex-col-reverse items-center gap-2 sm:mt-0 md:flex-row md:items-start md:justify-between md:gap-4">
          ...
          <div className="flex w-full flex-col items-center gap-2 md:items-end">
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.facebook.com/get.tractian/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <FacebookIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.instagram.com/get.tractian/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <InstagramIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.youtube.com/channel/UCmrRZOCxvMbDnR5haGfFe8w" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
                <YouTubeIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://x.com/tractian" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                <XIcon />
              </a>
              <a className="group relative flex items-center gap-x-2 text-slate-400 transition" href="tel:+18334388722" aria-label={t("phone")}>
