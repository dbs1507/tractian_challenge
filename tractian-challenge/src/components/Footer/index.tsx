...
const BADGES = [
  ...
  { alt: "AICPA", src: "https://imgix.tractian.com/website/components/footer/v2/aicpa-soc.png?auto=format,compress&cs=origin&fit=max&q=75&w=384", maxWidth: 52, w: 157, h: 156 },
  { alt: "SAP Silver Partner", src: "https://imgix.tractian.com/website/components/footer/v2/sap-partner.png?auto=format,compress&cs=origin&fit=max&q=75&w=640", maxWidth: 68, w: 205, h: 120 },
  { alt: "ISO 27001", src: "https://imgix.tractian.com/website/components/footer/v2/BadgeISO27001.png?auto=format,compress&cs=origin&fit=max&q=75&w=640", maxWidth: 90, w: 201, h: 80 },
  { alt: "Oracle Cloud", src: "https://imgix.tractian.com/website/components/footer/v2/oracle-cloud.png?auto=format,compress&cs=origin&fit=max&q=75&w=384", maxWidth: 59, w: 177, h: 138 },
  { alt: "ISO 9001", src: "https://imgix.tractian.com/website/components/footer/v2/iso-9001.png?auto=format,compress&cs=origin&fit=max&q=75&w=384", maxWidth: 42, w: 180, h: 158 },
...
const PRODUCT_SECTIONS: FooterSection[] = [
  {
    titleKey: "sectionCM",
    links: [
      { key: "cmVibration", href: "/en/solutions/condition-monitoring/vibration-analysis" },
      { key: "cmAiDetection", href: "/en/solutions/condition-monitoring/ai-powered-condition-monitoring" },
      { key: "cmReliability", href: "/en/solutions/condition-monitoring/root-cause-and-reliability" },
      { key: "cmDowntime", href: "/en/solutions/condition-monitoring/downtime-prevention-and-reporting" },
      { key: "cmSensorSpecs", href: "/en/solutions/condition-monitoring/sensor-specifications" },
    ],
  },
  {
    titleKey: "sectionCMMS",
    links: [
      { key: "cmmsTroubleshooting", href: "/en/solutions/cmms/maintenance-sop" },
      { key: "cmmsWorkOrder", href: "/en/solutions/cmms/work-order-software" },
      { key: "cmmsInventory", href: "/en/solutions/cmms/inventory-management-software" },
      { key: "cmmsPreventive", href: "/en/solutions/cmms/preventive-maintenance-software" },
      { key: "cmmsMobile", href: "/en/solutions/cmms/mobile-app" },
    ],
  },
  {
    titleKey: "sectionOEE",
    links: [
      { key: "oeeTracking", href: "/en/solutions/oee/ai-production-tracking" },
      { key: "oeeOperator", href: "/en/solutions/oee/operator-performance" },
      { key: "oeeQuality", href: "/en/solutions/oee/digitalized-quality" },
      { key: "oeeDashboards", href: "/en/solutions/oee/custom-dashboards" },
      { key: "oeeUtility", href: "/en/solutions/oee/energy-trac" },
    ],
  },
  {
    titleKey: "sectionPricing",
    links: [
      { key: "pricingCM", href: "/en/solutions/condition-monitoring/vibration-sensor/pricing" },
      { key: "pricingCMMS", href: "/en/solutions/cmms/pricing" },
      { key: "pricingOEE", href: "/en/solutions/oee" },
    ],
  },
];

const INTEGRATIONS_SECTION: FooterSection = {
  titleKey: "sectionIntegrations",
  links: [
    { key: "intOracle", href: "/en/solutions/integrations/oracle-netsuite" },
    { key: "intSAP", href: "/en/solutions/integrations/sap", external: true },
    { key: "intPowerBI", href: "/en/solutions/integrations/power-bi" },
    { key: "intAll", href: "/en/solutions/integrations" },
  ],
};

const RESOURCES_SECTION: FooterSection = {
  titleKey: "sectionResources",
  links: [
    { key: "resCaseStudies", href: "/en/case-studies" },
    { key: "resEbooks", href: "/en/resources", external: true },
    { key: "resBlog", href: "/en/blog" },
    { key: "resSOPs", href: "/en/assets" },
    { key: "resProductUpdates", href: "https://releases.tractian.com/en", external: true },
    { key: "resAcademy", href: "https://academy.tractian.com/en", external: true },
    { key: "resHelpCenter", href: "https://faq.tractian.com/en/", external: true },
    { key: "resCalculators", href: "/en/resources/calculators/maintenance-calculators" },
  ],
};

const SUPPORT_SECTION: FooterSection = {
  titleKey: "sectionSupport",
  links: [
    { key: "supAbout", href: "/en/about" },
    { key: "supReferrals", href: "/en/referrals" },
    { key: "supCareers", href: "https://careers.tractian.com/", external: true },
    { key: "supNewsroom", href: "/en/press" },
    { key: "supWarranty", href: "/en/hardware-warranty" },
    { key: "supSLA", href: "/en/service-level-agreement" },
    { key: "supTrust", href: "https://trust.tractian.com/", external: true },
  ],
};

const DOWNLOAD_SECTION: FooterSection = {
  titleKey: "sectionDownload",
  links: [
    { key: "dlApple", href: "https://apps.apple.com/app/tractian/id1590498655", external: true },
    { key: "dlGoogle", href: "https://play.google.com/store/apps/details?id=com.tractian.app&pli=1", external: true },
    { key: "dlSAP", href: "https://store.sap.com/dcp/en/product/display-2001016127_live_v1/tractian-ai-machine-intelligence-software", external: true },
  ],
};
...
function PhoneIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" className="h-4 w-4" strokeWidth="1.5">
...
function FooterLinkSection({
  ...
  return (
    <div className={`flex w-full flex-col gap-2 ${className ?? ""}`}>
      <p className="text-[14px] font-bold leading-[22px] text-slate-500">
        {t(section.titleKey)}
      </p>
      {section.links.map((link) => (
        <a
          key={link.key}
          className="text-[14px] leading-[22px] text-slate-500 hover:underline"
          href={link.href}
          ...
          <div className="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:gap-x-16 lg:gap-y-8">
            {PRODUCT_SECTIONS.map((section) => (
              <FooterLinkSection
                ...
                section={section}
                t={t}
                className="border-b border-slate-300 pb-4 sm:border-transparent lg:pb-0"
              />
            ))}
          </div>
          ...
          <div className="flex w-full flex-col gap-4 md:flex-row lg:gap-16 font-normal">
            ...
            <div className="flex w-full flex-col gap-4 sm:gap-8 lg:gap-12">
              <FooterLinkSection
                ...
                className="border-b border-slate-300 pb-4 sm:border-transparent lg:pb-0"
              />
              <FooterLinkSection section={DOWNLOAD_SECTION} t={t} />
            </div>
          </div>
        </div>
        ...
        <div className="mt-2 flex w-full flex-col-reverse items-center gap-2 sm:mt-0 md:flex-row md:items-start md:justify-between md:gap-4">
          ...
          <div className="flex w-full flex-col items-center gap-2 md:items-start">
            <button className="group flex items-center gap-x-2" type="button">
              <PrivacyIcon />
              <p className="text-xs text-slate-400 group-hover:underline sm:text-[14px] sm:leading-[22px]">
                {t("privacyChoices")}
              </p>
            </button>
            <p className="text-xs text-slate-400 sm:text-[14px] sm:leading-[22px]">
              {t("copyright", { year })}
            </p>
          </div>
          ...
          <div className="flex w-full flex-col items-center gap-2 md:items-end">
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.linkedin.com/company/get-tractian/" target="_blank" rel="noopener noreferrer" title="LinkedIn">
                <LinkedInIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.facebook.com/get.tractian/" target="_blank" rel="noopener noreferrer" title="Facebook">
                <FacebookIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.instagram.com/get.tractian/" target="_blank" rel="noopener noreferrer" title="Instagram">
                <InstagramIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://www.youtube.com/channel/UCmrRZOCxvMbDnR5haGfFe8w" target="_blank" rel="noopener noreferrer" title="YouTube">
                <YouTubeIcon />
              </a>
              <a className="transition-all ease-in-out lg:hover:brightness-110" href="https://x.com/tractian" target="_blank" rel="noopener noreferrer" title="X">
                <XIcon />
              </a>
              <a className="group relative flex items-center gap-x-2 text-slate-400 transition" href="tel:+18334388722">
                <PhoneIcon />
                <span className="text-xs group-hover:underline sm:text-[14px] sm:leading-[22px]">
                  {t("phone")}
                </span>
              </a>
            </div>
            <div className="flex flex-col lg:items-end">
              <a href="https://maps.app.goo.gl/DTDjgu4zXJrxbfWT9" target="_blank" rel="noopener noreferrer">
                <p className="text-center text-xs text-slate-400 hover:underline sm:text-[14px] sm:leading-[22px] md:text-right">
                  {t("address")}
                </p>
              </a>
            </div>
